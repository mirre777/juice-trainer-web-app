...
import { AssignProgramDialog } from "@/components/programs/assign-program-dialog" // Import the new dialog
import type { WorkoutProgram } from "@/types/workout-program" // Ensure this type is correctly imported

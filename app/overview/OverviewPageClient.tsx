          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Button onClick={() => router.push("/clients")} className="h-20">
              <div className="text-center">
                ...
                <div className="text-xs opacity-70">Register a new client</div>
              </div>
            </Button>
            <Button onClick={() => router.push("/calendar")} variant="outline" className="h-20">
              <div className="text-center">
                ...
                <div className="text-xs opacity-70">Book a training session</div>
              </div>
            </Button>
            <Button onClick={() => router.push("/programs")} variant="outline" className="h-20">
              <div className="text-center">
                ...
                <div className="text-xs opacity-70">Check client progress</div>
              </div>
            </Button>
          </div>
        </CardContent>

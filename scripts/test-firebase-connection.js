...
console.log("\n2️⃣ Testing Firebase Client Configuration...")
...
if (!clientConfigValid || !serverConfigValid || missingVars.length > 0) {
  ...
  console.log("   4. Redeploy after fixing missing variables")
} else {

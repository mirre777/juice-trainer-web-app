...
export function CalendarPageLayout({ isDemo = true }: CalendarPageLayoutProps) {
  ...
  // Use the toast hook safely (we're guaranteed to be on the client due to dynamic import with ssr: false)
